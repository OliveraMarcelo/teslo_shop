...
class _LoginForm extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    /*   final loginForm = ref.watch(loginFormProvider); tenemos asi acceso al acceso al estado */
    /*     final loginForm = ref.watch(loginFormProvider.notifier); asi tenemos acceso al notifier, y asus metodos
 */
    return Padding(
